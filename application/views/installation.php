...
<head>
    ...
    <style>
        .banner {
            ...
            display: block;
            width: 100%;
            background-image: url("<?= base_url() ?>assets/images/installation_header.jpeg");
                ...
                <div class="row">
                        <div class="col-md-6">
                            <div class="text-section left">
                                ...
                                <p>A problem-solver who can manage all aspects of security and solar system installation. As a member of our Installation &amp; Service team, you’ll work closely with our customers and our customer care team. You’ll ensure all systems are installed and running properly. You’ll need the ability to test all components, diagnose and troubleshoot, as well as repair and escalate issues as necessary. Ready to become an Everyday Hero and make a difference by helping others protect what matters most to them?
                                </p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="right visual">
                                <img src="<?=base_url()?>assets/images/installation2.jpg" alt="">
                            </div>
                        </div>
