                ...
                <div class="col-md-6" id="form1">
                    <div class="collage-section">
                        <div class="text-section left">
                            <br><br>
                            <p style="font-size: 2em;color: #196939;"><i style="" class="fa fa-check-circle"></i> Success!</p>
                            <span style="color:#212121;letter-spacing: -0.02em;line-height: 1.25em;pointer-events: auto;font-size: 1.4em;text-align: justify;">
                                Thank you for your interest in becoming a valuable team member to our team.  I appreciate you taking the time to submit your information.
                                A member of our management team will be reaching out to you.
                                <br><br>
                            We will be sending some additional resources to the email you have provided to us.
                                <br><br>
                            If you have any questions our support team is available to help you.  Please send any correspondence to support@adtpowur.com.
                                <br><br>
                            Sincerely,
                                <br><br><br>
                            Support Team
